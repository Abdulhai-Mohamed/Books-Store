...
function updateTimer() {
    ...
    var csharp_TotalMillisecondsToExpireWithoutaddCurrentMilieseconds = parseInt(document.getElementById("csharp_TotalMillisecondsToExpireWithoutaddCurrentMilieseconds").innerHTML)
    var csharp_TotalMillisecondToExpireAfteraddCurrentMilieseconds = parseInt(document.getElementById("csharp_TotalMillisecondToExpireAfteraddCurrentMilieseconds").innerHTML)
   

    var CSharpCurrentMilieseconds = parseInt(document.getElementById("CSharpCurrentMilieseconds").innerHTML)
